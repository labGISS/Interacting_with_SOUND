...
:auto LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/labGISS/prin-test/master/database/data/emerging.csv?token=GHSAT0AAAAAABQTRYJ5KHNTRDNBWT3UTL4EYTKWAJQ" as line
CALL {
    WITH line
